...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.transferAllButton.setText(_translate("MainWindow", "Transfer All (without resolving) >>"))
        self.resolvedLabel.setText(_translate("MainWindow", "User/Auto-resolved & Unique Traces"))
        self.transferRightButton.setText(_translate("MainWindow", "<< Transfer Selected (keep resolution)"))
